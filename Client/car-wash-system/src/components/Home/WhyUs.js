  ...
  return (
    <div className="component">
      <div className="banner">
        <div>
          <img className="banner__image" src={banner_2} alt="CarPro LOGO" />
        </div>
      ...
      <hr />
      <h1 className="banner__heading">The CarPro Way</h1>
      ...
      <div className="banner">
        ...
        <div>
          <img className="banner__image" src={banner_3} alt="CarPro LOGO" />
        </div>
      </div>

      <div className="banner">
        <div>
          <img className="banner__image" src={banner_4} alt="CarPro LOGO" />
        </div>
        <div className="banner__contentRight">
      ...
      <div className="banner">
        ...
        <div>
          <img className="banner__image" src={banner_5} alt="CarPro LOGO" />
        </div>
      </div>
    </div>
  );
